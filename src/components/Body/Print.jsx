...
export default function Print() {
    return (
        <div className='bg-[#faf6ef] px-5 lg:px-[120px] py-5  w-full flex flex-col-reverse lg:flex-row items-center'>
            {/* leftside  */}
            <div className='lg:w-[50%] lg:px-[50px]'>
                <p className='text-[18px] gelato-regular text-[#212121]' >For print on demand sellers</p>
                <h1 className='text-[2.5rem] lg:text-[60px] gelato-medium text-[#212121] leading-[40px] lg:leading-[60px] mt-3'>Accelerate business growth with innovative design tools and apps</h1>
