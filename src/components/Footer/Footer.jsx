...
export default function Footer() {
    ...
    return (
        <div className='bg-black px-5 lg:px-[100px] py-12'>
            {/* 1st  part*/}
            ...
            {/* 2nd part  */}
            <div>
                <div className='lg:flex lg:items-start lg:gap-5 text-white mt-5 w-full'>
                ...
                <div className=' lg:hidden mt-10'>
                    <p className='text-[16px] text-white gelato-light'>
                        Get the app
                    </p>
                    <div className='flex gap-2 items-center mt-3'>
                        <img src='https://a.storyblok.com/f/165154/x/de4bf52166/badge-1.svg' />
            ...
            {/* 3rd part */}
            <div className='mt-5 lg:mt-0 flex flex-col-reverse lg:flex-row justify-between'>
                <div className=''>
                    <div className='text-white flex flex-col lg:flex-row text-[12px] gelato-light items-start gap-2 mt-2 lg:gap-0 lg:mt-0'>
                        <button className='lg:border-r-2 lg:border-white px-4'>Contact us</button>
                        <button className='lg:border-r-2 lg:border-white px-4'>Legal</button>
                        <button className='lg:border-r-2 lg:border-white px-4'>Privacy policy</button>
                        <button className='lg:border-r-2 lg:border-white px-4'>Cookie policy</button>
                        <button className='lg:border-r-2 lg:border-white px-4'>API terms</button>
                ...
                <div className='relative inline-block gelato-light'>
                    ...
                    <button
                        className='text-white w-[200px] border-white border-2 text-start px-2 py-1 flex justify-between'
                        onClick={toggleMenu}
                    >
                        English (India)
                        <span>
