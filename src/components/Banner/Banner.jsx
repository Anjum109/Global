...
export default function Banner() {
    return (
        <div className='bg-[#faf6ef] px-10 lg:px-[200px] py-5  w-full'>
            <div className='flex flex-col-reverse lg:flex-row justify-between items-center w-full'>
                ...
                <div className='lg:w-[50%]'>
                    <div>
                        ...
                        <p className='gelato-regular text-[#212121] text-[1.5rem] lg:text-[24px] font-normal mt-5 lg:mt-0'>Sign up for free and only pay for what you sell</p>
                        <p className=' text-[#212121] text-[16px]  me-5 gelato-light mt-2 lg:mt-0'>Turn your passion into profit with the world's largest <span className=' underline hover:text-gray-400'>print on demand</span> network.</p>
                    </div>
                    <div className='my-3 flex flex-col lg:flex-row gap-5 lg:items-center w-[200px] lg:w-full mt-8 lg:mt-0'>
